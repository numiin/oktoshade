...
theme_background_color=1e2327
theme_foreground_color=969696

theme_octets=6

#     dark    red     green   yellow  blue    magenta cyan    white
fg1=( 000000  bb6870  819b5f  b2916c  5889a7  c7668e  a37dba  $theme_foreground_color )
fg2=( 000000  c28166  9ba329  b09c69  6c75da  be64b7  619e88  $theme_foreground_color )
bg1=( 191d1f  3a2522  1c3123  372f15  193048  3e233e  35264a  2f343c )
mid=64686e
...
theme_octet_2=(
  $mid    0    0    5    $fg1_r  0   28   10    $fg1_g -8   20    2    $fg1_y  0   27    8
  $fg1_b  0   28   12    $fg1_m  0   34    8    $fg1_c  0   34   12    $fg1_w  0    0   14
)
...
theme_octet_5=(
  $fg2_d  0    0    0    $fg2_r  0    0    0    $fg2_g  0    0    0    $fg2_y  0    0   -2
...
theme_octet_6=(
  ...
  $fg2_b -5   38   15    $fg2_m  0   28   10    $fg2_c  0   20    0    $fg2_w  0    0   14
)
